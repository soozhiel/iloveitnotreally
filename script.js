const SITE_URL = 'https://iloveitnotreally.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'I Love It Not Really — Sonic Remedy | Soozhee', text: 'I Love It Not Really by Soozhee. Sonic Remedy : Audiosensory Resonance | Letting Go.', url: SITE_URL }); return; } catch (e) {} }
